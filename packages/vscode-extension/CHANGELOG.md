...
- Support for external and already-generated generated assets in the live preview.

## [1.0.1] - 2026-07-20

### Fixed

- Live preview now works correctly in a codespace.
...
- Greatly improved conversion of LaTeX to PreTeXt.
...
- Cleaned up convert menu options: PreTeXt Markdown is now the default choice; move Plastex conversion to experimental features.
...
- New snippets for slideshows and handouts.

### Changed

- Snippets for `<me>` now resolve to `<md>` to match updates to pretext.
